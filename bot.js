...
if (message.content.startsWith('b!adminbcdwdwdwdwdwdwdwd')){
...
m.sendMessage(args)
  ...
  client.on("message", message => {
    if (message.content === "b!helpwdwdwdw") {
   ...
   client.on("message", message => {
    if (message.content === "b!invdwdwdwdwdwdwdwdwdite") {
     const embed = new Discord.RichEmbed()
         .setColor("RANDOM")
   ...
   client.on("message", message => {
    if (message.content === "b!suppdwdwdwdwdwdwdwort") {
     const embed = new Discord.RichEmbed()
         .setColor("RANDOM")
   ...
   client.on('message', message => {
    if (message.content.startsWith("b!bwdwdwdwdwdwdwdot")) {
...
client.on('ready', () => {
    console.log(`Logged in as ${client.user.tag} !`);
          ...
          client.user.setGame(` BroadCast Bot.  `,"http://twitch.tv/S-F")
